...
def test_parse_subscriber_hl_segment_no_dependent(data_context):
...
def test_parse_subscriber_hl_segment_with_dependent(data_context):
    segment_data = ['HL', '3', '2', '22', '1']
    parse_subscriber_hl_segment(segment_data, data_context, data_cache)
    assert data_context == {'is_subscriber': True, 'has_dependent': True}


def test_parse_dependent_hl_segment(data_context, data_cache):
...
def test_parse_subscriber_trn_segment(data_context, data_cache):
...
def test_parse_dependent_trn_segment(data_context, data_cache):
    segment_data = ['TRN', '1', '1', '1453915417']
...
def test_parse_subscriber_nm1_segment(data_context, data_cache):
...
def test_parse_dependent_nm1_segment(data_context, data_cache):
...
def test_parse_subscriber_group_number(data_context, data_cache):
...
def test_parse_dependent_group_number(data_context, data_cache):
    segment_data = ['REF', 'IL', '90210']
    data_context['is_subscriber'] = False
...
def test_parse_subscriber_n3_segment(data_context, data_cache):
...
def test_parse_dependent_n3_segment(data_context, data_cache):
    segment_data = ['N3', '1400 Anywhere Lane', 'Apt 215']
    data_context['is_subscriber'] = False
...
def test_parse_subscriber_n4_segment(data_context, data_cache):
...
def test_parse_dependent_n4_segment(data_context, data_cache):
    segment_data = ['N4', 'Standards City', 'SC', '90210']
    data_context['is_subscriber'] = False
...
def test_parse_subscriber_dmg_segment(data_context, data_cache):
...
def test_parse_dependent_dmg_segment(data_context, data_cache):
    segment_data = ['DMG', 'D8', '19900515', 'F']
    data_context['is_subscriber'] = False
